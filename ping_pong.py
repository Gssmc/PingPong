...
while True:
    ...
    if ball.xcor() > 390:   # right width paddle Border
        ...
        #os.system("C:\\Users\\Madesh\\Desktop\\gokulpythonprogeaming\\competitiveprograming\\JARVIS\\wallhit.wav")
    ...
    if(ball.xcor() > 340) and (ball.xcor() < 350) and (ball.ycor() < paddle_right.ycor() + 40 and ball.ycor() > paddle_right.ycor() - 40):
        ball.setx(340)
        ball_dx = ball_dx * -1
        #os.system("C:\\Users\\Madesh\\Desktop\\gokulpythonprogeaming\\competitiveprograming\\JARVIS\\paddle.wav")
